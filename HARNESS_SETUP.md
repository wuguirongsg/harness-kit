...
**Q4**：第一阶段（接下来 1-2 周）要完成哪些功能？请逐条列出，我来记录到 features.json。每条格式：`功能名称 — 简短描述`
...
### 3.0 .harness/product/vision.md（优先生成）

把 Q0 / Q0.5 / Q0.75 的答案填入对应章节：
- 产品定位（为谁、解决什么、一句话描述）
- 成功标准（可观测的判断依据）
- 明确不做什么（边界）
...
### 3.6 .harness/registry/_index.md
